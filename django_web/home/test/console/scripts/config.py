...
DEPLOY_PATH_SERVER_LINUX = DEPLOY_PATH_LATEST + SEP_COMM + SERVER +  SEP_COMM + SYSTEM_LINUX
DEPLOY_PATH_CLIENT_LINUX = DEPLOY_PATH_LATEST + SEP_COMM + CLIENT +  SEP_COMM + SYSTEM_LINUX
DEPLOY_PATH_XML_LINUX = DEPLOY_PATH_LATEST + SEP_COMM + XML +  SEP_COMM + SYSTEM_LINUX
FILE_SUF_BAT = '.bat'
FILE_SUF_SHELL = '.sh'
FILE_SUF_MD5 = '.md5'
FILE_SUF_ZIP = '.zip'
