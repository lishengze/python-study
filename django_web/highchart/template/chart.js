$(function () {
    // Create the chart
    var getJSONUrl = '/sendData/';

    var oriTimeIterVal = [1,1,1,1,1,
                       5,5,5,5,5,
                       30,30,30,30,30, 
                       60,60,60,60,60, 
                       300,300,300,300,300,
    ...
    var oriCplusBandwidth = [16.3666, 19.5179, 16.8915, 12.8952, 13.4720,
    ...
    var oriNodejsBandwidth = [16.2051, 16.0147, 15.6262, 15.6275, 16.4663, 
    ...
    var sendData = {
        'timeIterVal' : oriTimeIterVal,
        'cplusBandwidth': oriCplusBandwidth,
        'nodejsBandwidth': oriNodejsBandwidth
    }

    // $.getJSON(getJSONUrl, {'l': 1, 'm': 'bbb'}, function(callbackData){
    //     console.log (callbackData);
    //     // var timeIterVal = callbackData.timeIterVal;
    //     // var cplusBandwidth = callbackData.cplusBandwidth;
    //     // var nodejsBandwidth = callbackData.nodejsBandwidth;
